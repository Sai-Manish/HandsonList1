...
Date: 25-02-2020
Description: This program will get scheduling policy and modify the SCHED_RR scheduling policy.  Run the file using sudo ./a.out. 
*/
...
int main(){
        ...
        printf("Scheduled process scheduled under RR policy %d\n", curr_scheduling2);
